...
parser.add_argument("--voc12_root", default='FOOD103', type=str,
                    help="Path to VOC 2012 Devkit, must contain ./JPEGImages as subdirectory.")

# Dataset
parser.add_argument("--train_list", default="voc12/food103_train.txt", type=str)
parser.add_argument("--val_list", default="voc12/food103_val.txt", type=str)
parser.add_argument("--infer_list", default="voc12/food103_train.txt", type=str,
...
parser.add_argument("--pooling", default='gap', type=str, help='gap, gndp')
...
def RIB_learn(img, label, pack_RIB, optimizer, model, outputs_cam, RIB_step, previous_cam_sum, process_id, pack_target):
    ...
    for img_idx, img_target in enumerate(img): # img_idx:1 -> size 0.5
        ...
        cam = model(img_target[0].cuda())  # img: 2x3xwxh, cam: 2x21xw'xh'
    ...
    if args.pooling == 'gap':
        ...
        logits_total.append(torchutils.gndp2d(cam_RIB, keepdims=True, valid_cat=pack_RIB['label'], score_th=args.score_th, is_RIB=False)[:, :, 0, 0])
    ...
    with cuda.device(process_id%n_gpus):
        ...
        for iter, pack in enumerate(data_loader):
            ...
            train_dataset = voc12.dataloader.VOC12RIBDataset(args.train_list,
                                             voc12_root=args.voc12_root, food_sub_dir='train',
...
if __name__ == '__main__':
    ...
    dataset = voc12.dataloader.VOC12ClassificationDatasetMSF(args.train_list,
                                                             voc12_root=args.voc12_root, scales=args.cam_scales, sub_dir='train')
